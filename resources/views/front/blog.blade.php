			...
			<div class="col-md-8 col-sm-8 col-xs-8 blog_img ">	
				...
				<div class="row">
					...
					<div class="blog_txt about_sch">
						<a href="{{route('blogDetail',['id'=>$blog->id])}}" style="color: #505050;">
					...
					@elseif ( Config::get('app.locale') == 'pr' )
					  ...
					  <p class="mt_10">{!! $description !!}</p>      	   
                    @endif 
					<a href="{{route('blogDetail',['id'=>$blog->id])}}" class="readmore">@lang('blog.readmore')<i class="fa fa-angle-right pl_5" aria-hidden="true"></i><i class="fa fa-angle-right" aria-hidden="true"></i></a>
				</div>
