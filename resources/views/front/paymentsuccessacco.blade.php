  ...
  <div class="col-md-12 payment-success p-5">
    <div class="container">
      <div class="payment-container col-md-8 offset-md-2 p-5">
        ...
        <h6 class="text-center pt-3 pb-3 mt-4"> Your order number is <span class="font-weight-bold text-danger"> # {{$accommodationbooking->Orderid}} </span></h6>
        ...
        <div class="text-center mt-5" align="center">
          ...
          <tr>
            ...
            <th scope="col">£{{$accommodationbooking->price}}</th>
          </tr>
          <tr>
            <td>Receipt url</td>
            <td><a href="{{$accommodationbooking->receipt_url}}">Check</a></td>
          </tr>
          </tbody>
        </table>
