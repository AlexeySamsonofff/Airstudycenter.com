...
@section('title', 'Popular Schools in ' .$cityname)
@section('content')
<div class="container-fluid bg-school text-white  position-relative p-0" style="background-image:url({{ asset('front/dpassets/img/CompanyBg.png') }}); height:475px;">
    ...
    <h1 class="text-center text-white font-weight-normal pt-5 all-center" style="font-size: 45px;">Popular Schools in {{ $cityname }}</h1>
</div>
<section>
    <div class="container p-0">
        <nav aria-label="breadcrumb " class="bg-transparent brdcrm">
            <p class="breadcrumb text-break pl-md-0 d-inline-block bg-transparent">
                ...
                <span class="breadcrumb-item" aria-current="page">{{ $cityname }}</span>
            </p>
        </nav>
                ...
                <div class="w-85">
                    <div class="searchingResult">
                        <div class="resultBlock mt-5">
                            <h2 class="result-heading2" style="font-size:30px !important">{{ $cityname }}</h2>
                            ...
                            <div class="check row m-0 pb-1 mb-3 cart-exchange border-top-0 border-left-0 border-right-0">
                                ...
                                <div class="col-2 text-right pt-lg-0 pt-md-1 p-0">
                                    <a href="#" onclick="javascript:addCourseToBasket({{$course->schoolId}}, {{$course->courseId}}, '{{ getLocalizedString($course->courseTitles, 'name') }}', {{$course->ppw1}});" data-transport-type="" class="table_transport text-primary addingCartSchool rounded p-2 p-lg-0  d-inline-block bg-after-md-primary text-after-md-white ">
