                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="profile-sidebar">
                                    <!-- SIDEBAR USERPIC -->
                                    <form class="form" action="{{route('changeProfileImage')}}" method="post"
                                        enctype="multipart/form-data" id="changeProfile">
                                        @csrf
                                        <div class="profile-userpic col-lg-12 text-center float-left">
                                            ...
                                            @else
                                            <img title="profile image" id="image_upload_preview"
                                                class="img-circle img-responsive" src="{{Auth::user()->image}}">
                                            @endif
                                        </div>
                                        <!-- END SIDEBAR USERPIC -->
                                        <!-- SIDEBAR USER TITLE -->
                                        ...
                                        <div class="profile-userbuttons">
                                            ...
                                            <button class="btn btn-success btn-sm" type="button"
                                                onclick="change();">@lang('profile.change_file')</button>
                                            <!-- <button class="btn btn-success btn-sm" type="button" onclick="remove();">Remove File</button> -->
                                            <button class="btn btn-success btn-sm"
                                                type="submit">@lang('profile.save')</button>
                                            <input type="file" id="inputFile" name="image" accept="image/*"
                                                class="text-center center-block file-upload" style="display: none;">
                                    ...
                                    <div class="profile-usermenu">
                                        <ul class="nav nav-tabs tabs-left profile-usermenu">
                                            <li><a href="#profile_overview"
                                                    data-toggle="tab">@lang('profile.overview')</a></li>
                                            <li><a href="#invite_friends"
                                                    data-toggle="tab">@lang('profile.invite_friends')</a></li>
                                            <li><a href="#profile_credits"
                                                    data-toggle="tab">@lang('profile.my_credits')</a></li>
                                            <li><a href="#saved_school"
                                                    data-toggle="tab">@lang('profile.saved_school')</a></li>
                                            <li><a href="#saved_courses"
                                                    data-toggle="tab">@lang('profile.saved_course')</a></li>
                                            <li><a href="#saved_accommodation"
                                                    data-toggle="tab">@lang('profile.saved_acc')</a></li>
                                            <li><a href="#paid_course" data-toggle="tab">
                                                    @lang('profile.paid_course')</a></li>
                                            <li><a href="#paid_accommodation" data-toggle="tab">
                                                    @lang('profile.paid_acc')</a></li>
                                            <li>
                       ...
                       document.getElementById('logout-form').submit();"> @lang('profile.logout')</a> </li>
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="profile_overview">
                                        <div class="profile-content table-responsive p-sm-0">
                                            <table class="table table-user-information">
                                                <tbody>
                                                    <tr>
                                                        <th style="border-top:0" colspan="2">{{Auth::user()->name}}
                                                            @lang('profile.profile') <a href="{{route('editUser')}}"
                                                                class="float-right">@lang('profile.ctep')</a></th>
                                                    </tr>
                                                    <tr>
                                    ...
                                    <div class="tab-pane" id="invite_friends">
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="inner_refer mt-0 bg-light">
                                                        <div class="row">
                                                            <div
                                                                class="col-md-10 col-sm-10 col-xs-10 offset-xs-1 offset-md-1 offset-sm-1 text-center">
                                                                <div class="cus_title refer_txt">
                                                                    <h5>@lang('profile.share_link')</h5>
                                                                </div>
                                                                <p class="custom_p main-head">
                                                                    @lang('profile.introduce')<br />
                                                                    @lang('profile.guest_rtt')</p>
                                                            </div>
                                                        </div>
                                                        <div class="share_links">
                                                            <div
                                                                ...
                                                                <div class="row">
                                                                    <ul>
                                                                        <li><a
                                                                                href="https://web.whatsapp.com/send?text=http://airstudycenter.com/?code={{$concatinate}}"><img
                                                                                    class="full"
                                                                                    src="{{asset('front/images/whatsapp.png')}}" /><span>@lang('profile.wttsapp')</span></a>
                                                                        </li>
                                                                        <li><a href="https://plus.google.com/share?url=http://airstudycenter.com/?code={{$concatinate}}"
                                                                                title="Share by Email"><img class="full"
                                                                                    src="{{asset('front/images/rsz_google-logo-1-resized.jpg')}}" /><span>@lang('profile.email')</span></a>
                                                                        </li>
                                                                        <li><a href="https://www.facebook.com/sharer/sharer.php?u=http://airstudycenter.com/?code={{$concatinate}}"
                                                                                target="_blank"><img class="full"
                                                                                    src="{{asset('front/images/facebook.png')}}" /><span>@lang('profile.facebook')</span></a>
                                                                        </li>
                                                                        <li><a
                                                                                href="https://twitter.com/intent/tweet?url=http://airstudycenter.com/?code={{$concatinate}}"><img
                                                                                    class="full"
                                                                                    src="{{asset('front/images/twiter.png')}}" /><span>@lang('profile.twitter')</span></a>
                                                                        </li>
                                                                        <li><a href="#"><img class="full"
                                                                                    src="{{asset('front/images/linkdin.png')}}" /><span>@lang('profile.linkdin')</span></a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div
                                                            class="col-md-10 col-sm-10 col-xs-10 offset-md-1 offset-sm-1 text-center or">
                                                            <span>@lang('profile.or')</span>
                                                            <p>@lang('profile.share_link')</p>
                                                            <div class="row">
                                                                <div
                                                                    class="col-md-7 col-sm-7 col-xs-9 input-field input-link review_form">
                                                                    <input class="form-control w-100"
                                                                        value="http://airstudycenter.com/?code={{$concatinate}}">
                                                                </div>
                                                                <div
                                                                    class="col-md-5 col-sm-5 col-xs-3 pl-0 text-center invite_send">
                                                                    <a class="send"
                                                                        href="mailto:?subject=I wanted you to see this site&amp;body=Check out this site http://airstudycenter.com/?code={{$concatinate}}">@lang('profile.send_invite')</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="font-weight-bold text-success">
                                                                        @lang('profile.total_points')</td>
                                                                    <td
                                                                        class="font-weight-bold text-success text-center">
                                                                        {{$total_credit}}</td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                            ...
                                            <div class="w-100">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-md-6 inner_language float-left ">
                                                        <a
                                                            href="{{route('schooldetail',['id'=>$school->id,'slug'=>$school->slug])}}">
                                                            <div class="box_outer">

                                                                @if($school->image != null)
                                                                <img class="full_img"
                                                                    src="{{asset('thumbnail_images/'.$school->image)}}">
                                                                @else
                                                                <img class="full_img"
                                                                    src="{{asset('front/images/image-not-available.png')}}"
                                                                    style="height:136px;">
                                                                @endif
                                                                <div class="deal_box">
                                                                    ...
                                                                    <div class="review_box">
                                                                        <div class="loc_left">
                                                                            <h5><i
                                                                                    class="fa fa-map-marker"></i>{{$school->city}},
                                                                                {{$school->country}}</h5>
                                                                        </div>
                             ...
                             $explode    = explode('.',$starNumber);
                                ...
                                while ($x<=5) { ?>
                                                                    ...
                                                                    <div class="box-bottom box_language">
                                                                        <div
                                                                            class="col-md-6 col-sm-6 col-xs-6 wd50 float-left grey-border age">
                                                                            <p>{{$school->agelimit}}
                                                                                @lang('profile.years') +</p>
                                                                        </div>
                                                                        <div
                                                                            class="col-md-6 col-sm-6 col-xs-6 wd50 float-right">
                                                                            <p>{{$school->courseCount}}
                                                                                @lang('profile.course')</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="view text-center">
                                                        <a
                                                            href="{{route('mainAllSchool')}}">@lang('profile.view_all_school')</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- paid courses content finsih -->
                                            ...
                                            <div class="mt-20">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 course_col">
                                                        <a
                                                            href="{{route('singleCourse',['id'=>$course->coursePid,'slug'=>$course->slug])}}">

                                                            <div class="box_outer">
                                                                <img class="full_img"
                                                                    src="{{asset('thumbnail_images/'.$course->image)}}"
                                                                    alt="" />
                                                                ...
                                                                <div class="deal_box">
                                                                    ...
                                                                    <div class="review_box">
                                                                        <div class="loc_left">
                                                                            <h5><i
                                                                                    class="fa fa-map-marker"></i>{{$course->city}},{{$course->country}}
                                                                            </h5>
                                                                        </div>
                                                                        <div class="review_rgt">
                                                                            <div class="school_comment AirSmallStar">
                             ...
                             $explode    = explode('.',$starNumber);
                                ...
                                while ($x<=5) { ?>
                                                    ...
                                                    <div class="cus_btn btn_round btn_full">
                                                        <a
                                                            href="{{route('allCourse')}}">@lang('profile.view_all_course')</a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane" id="saved_accommodation">
                                        ...
                                        <div class="profile-content">
                                            <h6 class="mb-3 w-100 float-left">@lang('profile.my_saved_accommodation')
                                            </h6>
                                            <div class="clearfix"></div>
                                            <!-- paid courses content starts -->
                                            <div class="w-100">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-md-6 inner_language float-left ">
                                                        <div class="box_outer">
                                                            ...
                                                            <a
                                                                href="{{route('accommodationDetail',['id'=>$accommodation->id,'slug'=>$accommodation->slug])}}"><img
                                                                    class="full_img"
                                                                    src="{{asset('thumbnail_images/'.$accommodation->image)}}"></a>
                                                            @else
                                                            <img class="full_img"
                                                                src="{{asset('front/images/image-not-available.png')}}"
                                                                style="height:136px;">
                                                            ...
                                                            <div class="box-1 m-b-40">
                                                                <h3><a
                                                                        href="{{route('accommodationDetail',['id'=>$accommodation->id,'slug'=>$accommodation->slug])}}">
                                                                        @if ( Config::get('app.locale') == 'en')
                                                                        {{$accommodation->name}}
                                                                        @elseif ( Config::get('app.locale') == 'tr' )
                                                                ...
                                                                <div class="marker">
                                                                    <h5><i
                                                                            class="fa fa-map-marker"></i>{{$accommodation->city}},
                                                                        {{$accommodation->country}}</h5>
                                                                    <!-- <h6>Review</h6>
                        ...
                        ?>
                             ...
                             $explode    = explode('.',$starNumber);
                                ...
                                while ($x<=5) { ?>
                                                                    ...
                                                                    <div class="box-bottom box_language">
                                                                        <div
                                                                            class="col-md-12 col-sm-12 col-xs-12 float-left grey-border age">
                                                                            <p>@lang('profile.acc_type')
                                                                                :{{$accommodation->roomtype}}</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="view text-center">
                                                        <a
                                                            href="{{route('allaccommodation')}}">@lang('profile.view_all_accs')</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- paid courses content finsih -->
                                    ...
                                    <div class="tab-pane" id="paid_course">
                                        <div class="profile-content">
                                            <h6 class="mb-3 w-100 float-left">@lang('profile.my_paid_course')</h6>
                                            <div class="clearfix"></div>
                                            <!-- paid courses content starts -->
                                            <div class="w-100">
                                                <div class="row">
                                                    ...
                                                    <div class="table-responsive table-striped">
                                                        <table class="table">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a href="@if($bookedcourse->slug){{route('schooldetail',['id'=>$bookedcourse->school_id,'slug'=>$bookedcourse->slug])}}@endif">
                                                                        @if
                                                                ...
                                                                <td><a href="{{$bookedcourse->receipt_url}}"
                                                                        target="_blank">@lang('profile.check')</a></td>
                                                                <td>{{$bookedcourse->created_at}}</td>
                                                                <td><button class="btn btn success"><a
                                                                            href="{{route('generatepdf',['id'=>$bookedcourse->id])}}">@lang('profile.print')</a></button>
                                                                </td>
                                                    ...
                                                    <div class="table-responsive table-striped">
                                                        <table class="table">
                                                            ...
                                                            <tr>
                                                                <td>{{$loop->iteration}}</td>
                                                                <td><a
                                                                        href="{{route('accommodationDetail',['slug'=>$accobooking->slug,'id'=>$accobooking->accommodationId])}}">@if
                                                                        ( Config::get('app.locale') == 'en')
                                                                        {{$accobooking->name}}
                                                                        @elseif ( Config::get('app.locale') == 'tr' )
                                                                        {{$accobooking->name_tr}}
                                                                        ...
                                                                        {{$accobooking->name_fa}}
                                                                        @elseif ( Config::get('app.locale') == 'pr' )
                                                                        {{$accobooking->name_pr}} @endif</a></td>
                                                                <td>@if ( Config::get('app.locale') == 'en')
                                                                    ...
                                                                    @elseif ( Config::get('app.locale') == 'pr' )
                                                                    {{$accobooking->typename_pr}} @endif</td>
                                                                <td><a href="{{$accobooking->receipt_url}}"
                                                                        target="_blank">@lang('profile.check')</a></td>
                                                                <td>£{{$accobooking->price}}</td>
                                                                <td>{{$accobooking->created_at}}</td>
                                                                <td><button class="btn btn success"><a
                                                                            href="{{route('generateaccpdf',['id'=>$accobooking->id])}}">@lang('profile.print')</a></button>
                                                                </td>
