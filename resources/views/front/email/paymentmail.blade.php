...
$template = App\Accbooktemplate::where('id', 1)->first();
...
<style>	
	...
	.table_tr td{float:left;width:46%;padding: 4px 0px; font-size:16px; color:#000; line-height: 24px; font-family: 'Poppins', sans-serif;}
	.table_tr_border{padding:8px 0px;border-top:1px solid #717171;border-bottom:1px solid #717171;margin: 10px 0px;}
	.table_tr_border td{font-size:20px;color:#000;line-height: 30px;font-family: 'Poppins', sans-serif;}
			...
			<td>
				<table style="margin:auto;" cellspacing="0" cellpadding="0" border="0">
					<tbody>
						...
						<tr> 
						<td style="margin:30px 0px 25px;background: #2e407c;display: block;color: #fff;padding: 14px 30px;font-size: 18px;line-height: 21px;font-family: 'Poppins', sans-serif;font-weight: 600;letter-spacing: 1px;">Detail</td>
						</tr>
						<tr style="clear:both;" class="table_tr">
							<td style="padding-left:4%;">Order No</td>
							<td style="text-align:right;padding-right:4%;"><b>{{$order_no}}</b></td>
						</tr>
						<tr style="clear:both;" class="table_tr">
							<td style="padding-left:4%;">Accommodation Name</td>
							<td style="text-align:right;padding-right:4%;"><b>{{$accname}}</b></td>
						</tr>
						<tr style="clear:both;" class="table_tr">
							<td style="padding-left:4%;">Accommodation </td>
							<td style="text-align:right;padding-right:4%;"><b>{{$acctype}}</b></td>
						</tr>

						@if(!empty($acctypename))
						<tr style="clear:both;" class="table_tr">
							<td style="padding-left:4%;">Accommodation Type</td>
							<td style="text-align:right;padding-right:4%;"><b>{{$acctypename}} </b></td>
						</tr>
						@endif
						<tr style="clear:both;" class="table_tr">
							<td style="padding-left:4%;">Accommodation Food</td>
							<td style="text-align:right;padding-right:4%;"><b>@if($accFood == "price"){{"No"}}@else{{"Yes"}}@endif</b></td>
						</tr>
						<tr style="clear:both;" class="table_tr">
							<td style="padding-left:4%;">Total Price</td>
							<td style="text-align:right;padding-right:4%;"><b>&#163;{{$totalPrice}}</b></td>
						</tr>
						<tr style="text-align:center;">
