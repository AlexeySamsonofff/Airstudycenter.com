...
<table class="main_table" style="margin:auto;background:#1e3574;" cellspacing="0" cellpadding="0" border="0" border-collapse="collapse">
	<tbody>
		...
		<tr class="white_bg_color" style="background:#fff;display: -webkit-box;">
			<td style="margin-bottom:15px; width:100%; ">
				<table style="margin:auto;" cellspacing="0" cellpadding="0" border="0">
					<tbody>
						<tr> 
							<td style="margin:30px 0px 25px;background: #2e407c;display: block;color: #fff;padding: 14px 30px;font-size: 18px;line-height: 21px;font-family: 'Poppins', sans-serif;font-weight: 600;letter-spacing: 1px;">Contact Detail</td>
						</tr>
						<tr style="clear:both;" class="table_tr">
							<td style="padding-left:4%;">Name</td>
							<td style="text-align:right;padding-right:4%;"><b>{{$name}}</b></td>
						</tr>
						<tr style="clear:both;" class="table_tr">
							<td style="padding-left:4%;">Email</td>
							<td style="text-align:right;padding-right:4%;"><b>{{$email}}</b></td>
						</tr>
						<tr style="clear:both;" class="table_tr">
							<td style="padding-left:4%;">Message</td>
							<td style="text-align:right;padding-right:4%;"><b>{{$bodyMessage}}</b></td>
						</tr>
					</tbody>
				</table> 
			</td>			
