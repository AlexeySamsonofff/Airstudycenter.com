...
<section class="city_school">
	<div class="container">
			...
			<div class="col-md-12">
				<div class="school_des s_tabs">
					 <ul class="nav nav-tabs" id="myTab" role="tablist">
					  ...
					  <li class="nav-item">
						<a class="nav-link" id="street-view-tab" data-toggle="tab" href="#street-view" role="tab" aria-controls="contact" aria-selected="false">@lang('school.street_view')</a>
					  </li>
					  <li class="nav-item">
				...
				<div class="tab-content" id="myTabContent">
					<div class="tab-pane fade show active" id="images" role="tabpanel" aria-labelledby="images-tab">
						...
						<!-- Wrapper for slides -->
						<div class="carousel-inner school-detail">
								@if($school->images == 'noimage')
						...
						@if(Auth::check())
							...
							<div class="detail-banner-btn heart">
								...
								<i class="fa fa-heart-o heart_submit"></i> <span data-toggle="@lang('school.love_it')">@lang('school.give_heart')</span>
							</div>
							@else
							<div class="detail-banner-btn heart marked">
								<input type="hidden" class="heart_input" value="1">
								<input type="hidden" class="heart_schoolid" value="{{$school->id}}">
								<i class="fa fa-heart-o heart_submit"></i> <span data-toggle="@lang('school.give_heart')">@lang('school.love_it')</span>
							</div>
							@endif
						@else
		...
		<div class="row">
			...
			<div class="col-md-12 custome_remove_padding">
				...
				<div class="tab-content" id="myTabContent">
					<div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
						<div class="row" style="margin-bottom: 15px">
							@if (isset($logo->logo))
							<div class="col-md-2">
								<img class="img-thumbnail" src="@if(isset($logo->logo)){{asset('logo_images/'.$logo->logo)}} @endif" alt="{{$school->name}}-logo" style="width:100%;">
							</div>
							@endif
							<div class="col-md-10 city_head" style="@if(isset($logo->logo)){{'padding-left:0px'}} @endif">
						...
						<div class="row">
							<div class="col-md-8 col-sm-7 col-xs-7 add">
				...
				<div class="row sch_wb">
					<div class="col-12 mb-2 add user-email">
						...
						<a class="text-success"href="mailto:{{$school->email}}?Subject=subject here&Body=bodytext">
						    {{$school->email}}
						</a>
						</span>
					</div>
			...
			<div class="row text-center bt ">
				<div class="british">
					<div class="outer_border">
						<h5>{{$school->recognised_by}}</h5>
						<span>@lang('school.recognised_by')</span>
					</div>
				</div>
				<div class="student">
					<div class="outer_border">
			...
			<div class="row about_sch">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="student_fac about_sch">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="students_percentage">
							...
							<div class="per_stu text-center"><span>@lang('school.pos')</span></div>
   ...
   <!-- SLIDER STARTS-->
	...
	<div class="owl-carousel owl-theme deal_carousel inter_head">
		@foreach($schoollists as $schoollist)
                        ...
                        @else
                        <img class="full"  src="{{asset('front/images/image-not-available.png')}}" style="height:83px;">
                        @endif
							<div class="school_in text-center centers">
								<h2 class="stu"><a class="text-success" href="{{route('schooldetail',['id'=>$schoollist->id,'slug'=>$schoollist->slug])}}"> @if ( Config::get('app.locale') == 'en')
	                 {{$schoollist->name}}
	                @elseif ( Config::get('app.locale') == 'tr' )
	                 {{$schoollist->name_tr}}
	                @elseif ( Config::get('app.locale') == 'ar' )
   ...
   <!-- SLIDER ENDS -->
			<div class="col-md-4 course_inner choose_sec bg-yel cal ">
