            ...
            <div class="col-md-8 p-md-0">
                ...
                <div class="row m-0 mb-5 enquirydetail">
                    <div class="col-md-9 pl-md-0 pb-4 pr-0 mark1" >
                        ...
                        <p class="mb-2 titlespan"><i class="bg-light rounded-circle fas fa-utensils"></i>{{$input['accoType']}}</p>                      
                    ...
                    <div class="col-md-3 pl-1 pr-0 mark2">
                        <img src="{{asset('front/dpassets/img/ClientImg.png')}}" alt="" class="img-owner rounded-circle pricespan" style="float:right">                       
                        <span class="pricespan">£p/w {{$input['price']}}</sapn></br>
                    </div>
                
                    <div class="col-md-12 pl-md-0 pb-2 pr-0" style="border-top-style: outset;">
                    <span class="titlespan">Total price</span>
                    <span class="pricespan font-bold"> Total £ {{$input['total_price']}} </span><br>
                    <span class="titlespan">Your deposit payment today </span>
                    <span class="pricespan"> Total £  {{$input['total_price']}}</span>
                    </div>
                    <div class="col-md-12 pl-md-0 pb-2 pr-0" style="border-top-style: outset;">
                    <span class="titlespan">Final payment amount on arrival</span>
                    <span class="pricespan"> £ {{$input['total_price']}}</span>
                    </div>
                </div>
                ...
                <div class="row m-0 mb-5 enquirydetail" > 
                    <div class="col-lg-12">
                        <form method="POST" action="{{url('/stripePost_Accommodation') }}" id="payment-form" class="require-validation" data-cc-on-file="false"  data-stripe-publishable-key="{{ env('STRIPE_KEY') }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <span class="titlespan row" style="color:#8398B6;">By continuing you agree the following: booking conditions and terms and conditions</span>
                            <input type="hidden" name="accommodationId" value="{{$input['accommodationId']}}">
                            <input type="hidden" name="accoType" value="{{$input['accoType']}}">
                            <input type="hidden" name="accFood" value="{{$input['accFood']}}">
