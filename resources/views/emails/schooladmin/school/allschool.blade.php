  ...
  <div class="content-wrapper data">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-xs-12 mb-2">
        	<h3 class="content-header-title mb-0">All Schools</h3>
    	</div>  
                    ...
                    <table class="table table-striped table-bordered zero-configuration">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{$school->name}}</td>
                          <td><a href="{{route('allSchoolAccommodation',['id'=>$school->id])}}"><button type="button" class="btn btn-outline-warning">View</button></a></td>
                          <td><a href="{{route('allcourse',['id'=>$school->id])}}"><button type="button" class="btn btn-outline-warning">View</button></a></td>
                          <td><a href="{{route('editSchool',['id'=>$school->id])}}"><button type="button" class="btn btn-outline-warning" ><i class="fa fa-pencil"></i></button></a></td>
                          <td><button type="button" class="btn btn-outline-warning" onclick="deleteSchool({{$school->id}})"><i class="fa fa-trash"></i></button></td>    
