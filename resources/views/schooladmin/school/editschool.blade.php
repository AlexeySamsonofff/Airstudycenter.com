                                        ...
                                        <fieldset>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            <div class="col-md-12">Accreditations</div>
                                                        </div><br />
                                                                    ...
                                                                    <div class="w-100 float-left rmv_repeat repeat-section-{{$id}}  mb-3">
                                                                        ...
                                                                        <div class="form-group input_fields_container">
                                                                            ...
                                                                            <style type="text/css" media="screen">
                                                                                ...
                                                                                .box-listing .w-7per:last-child {
                                                                                    padding-right: 0;
                                                                                }
                                                                            </style>
                                                                            <input type="hidden" name="coursepriceid-{{$id}}[]" value="{{$price->id}}">
                                                                            <div class="controls remove_control">
                                                                                <div class="col-md-12 box-listing">
                                                                                    <div row-id="{{$id}}" class="row row-{{$id}}">
                                                                                        ...
                                                                                        <div class="w-7per"><label>Course Details</label>
                                                                                            <textarea name="course_detail-{{$id}}[]" value="{{ $price->course_detail }}" class="form-control" aria-invalid="false"></textarea>
                                                                                        </div>
                                                                                        <br /><br /><br /><br />
