...
<!-- END STACK JS-->
<!-- BEGIN PAGE LEVEL JS-->
<!-- <script src="{{asset('accommodationadmin/app-assets/js/scripts/pages/dashboard-ecommerce.min.js')}}" type="text/javascript"></script> -->
<script src="{{asset('accommodationadmin/app-assets/js/scripts/tables/datatables/datatable-basic.js')}}"type="text/javascript"></script>
<script src="{{asset('accommodationadmin/app-assets/js/scripts/forms/validation/form-validation.js')}}"type="text/javascript"></script>

<script src="{{asset('accommodationadmin/app-assets/js/scripts/extensions/toastr.min.js')}}" type="text/javascript"></script>
<!-- <script src="{{asset('accommodationadmin/app-assets/js/scripts/forms/switch.min.js')}}" type="text/javascript"></script> -->
<script src="{{asset('accommodationadmin/app-assets/vendors/js/extensions/jquery.steps.min.js') }}" type="text/javascript"></script>
<script src="{{asset('accommodationadmin/app-assets/vendors/js/pickers/daterange/daterangepicker.js')}}"
  type="text/javascript"></script>

  

<script src="{{asset('accommodationadmin/app-assets/js/scripts/forms/wizard-steps.min.js')}}" type="text/javascript"></script>
...
<script src="{{asset('accommodationadmin/app-assets/vendors/js/pickers/dateTime/moment-with-locales.min.js') }}" type="text/javascript"></script>
<script src="{{asset('accommodationadmin/app-assets/js/scripts/forms/select/form-select2.min.js')}}" type="text/javascript"></script>
