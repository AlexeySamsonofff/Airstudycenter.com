...
<div class="col-md-4 content-desktop" style="background-color:white;border: 1px solid;border-color: rgba(18, 100, 112, 0.3);border-radius: 5px; margin-top: -50px; height: 480px">
    <div class="row" style="padding-top: 30px">
        ...
        ?>
            ...
            @else
                <img src="{{asset('accommodationadmin/app-assets/images/portrait/small/avatar-s-1.png')}}" alt="User Avatar" class="rounded-circle" style="width: 72px;">
            @endif
        </div>
    ...
    <div class="row">
        <div class="form-group col-md-12 dropdown-item">
            <a href="{{ route('inbox')}}" style="color: #374354"><h5 class="{{ Request::is('inbox') ? 'left-menu-active' : '' }}"><i class="fa fa-envelope"> Inbox</i></h5></a>
        </div>
    </div>
    <div class="row">
        <div class="form-group col-md-12 dropdown-item">
            <a href="#" style="color: #374354"><h5 class="{{ Request::is('userprofile') ? 'left-menu-active' : '' }}"><i class="fa fa-user"> My profile</i></h5></a>
        </div>
    </div>
    <div class="row">
        <div class="form-group col-md-12 dropdown-item">
            <a href="#" style="color: #374354"><h5 class="{{ Request::is('wishlistcourse') ? 'left-menu-active' : '' }}"><i class="fa fa-heart"> Wishlist</i></h5></a>
        </div>
    </div>
    <div class="row">
        <div class="form-group col-md-12 dropdown-item">
            <a href="#" style="color: #374354"><h5 class="{{ Request::is('payment') ? 'left-menu-active' : '' }}"><i class="fa fa-history"> Payment history</i></h5></a>
        </div>
    </div>
   
</div>
<div class="content-mobile" style="width:100% ; display:none" >
