...
class CountryController extends Controller
{
    ...
    {
        $countries = Country::find($request->id);
        $schooladdress = Schooladdress::where('countryId', $request->id)->delete();
    ...
    public function state()
    {
        ...
        return view('superadmin.country.state',compact('states','countries'));
    }
    ...
    {
        $states = State::find($request->id);
        $schooladdress = Schooladdress::where('stateId', $request->id)->delete();
    ...
    public function city()
    {
        ...
        return view('superadmin.country.city',compact('cities','countries'));
    }
    ...
    {
        $cities = City::find($request->id);
        $schooladdress = Schooladdress::where('cityId', $request->id)->delete();
        if($cities->delete())
        {
            return 1;
        }
    ...
    public function zipcode()
    {
        ...
        return view('superadmin.country.zipcode',compact('countries','zipcodes'));
    }
    ...
    {
        $zipcodes = Zipcode::find($request->id);
        $schooladdress = Schooladdress::where('zipCodeId', $request->id)->delete();
